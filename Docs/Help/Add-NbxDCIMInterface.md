...
```
Add-NbxDCIMInterface [-Device] <ulong> [-Name] <string> [[-Type] <string>] [[-Enabled] <bool>]
 [[-Form_Factor] <Object>] [[-MTU] <ushort>] [[-MAC_Address] <string>] [[-MGMT_Only] <bool>]
 [[-LAG] <ulong>] [[-Description] <string>] [[-Mode] <string>] [[-Untagged_VLAN] <ushort>]
