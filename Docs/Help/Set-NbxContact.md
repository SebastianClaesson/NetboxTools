...
```
Set-NbxContact [-Id] <ulong[]> [[-Name] <string>] [[-Email] <string>] [[-Group] <ulong>]
 [[-Title] <string>] [[-Phone] <string>] [[-Address] <string>] [[-Description] <string>]
 [[-Comments] <string>] [[-Link] <string>] [[-Custom_Fields] <hashtable>] [-Force] [-Raw] [-WhatIf]
