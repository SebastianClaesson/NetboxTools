...
title: Set-NbxContactAssignment
---
...
```
Set-NbxContactAssignment [-Id] <ulong[]> [[-Content_Type] <string>] [[-Object_Id] <ulong>]
 [[-Contact] <ulong>] [[-Role] <ulong>] [[-Priority] <string>] [-Raw] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
