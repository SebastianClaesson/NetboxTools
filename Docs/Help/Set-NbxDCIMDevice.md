...
```
Set-NbxDCIMDevice [-Id] <ulong[]> [[-Name] <string>] [[-Device_Role] <Object>]
 [[-Device_Type] <Object>] [[-Site] <ulong>] [[-Status] <Object>] [[-Platform] <ulong>]
 [[-Tenant] <ulong>] [[-Cluster] <ulong>] [[-Rack] <ulong>] [[-Position] <ushort>]
 [[-Face] <Object>] [[-Serial] <string>] [[-Asset_Tag] <string>] [[-Virtual_Chassis] <ulong>]
 [[-VC_Priority] <ulong>] [[-VC_Position] <ulong>] [[-Primary_IP4] <ulong>] [[-Primary_IP6] <ulong>]
 [[-Comments] <string>] [[-Custom_Fields] <hashtable>] [-Force] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
