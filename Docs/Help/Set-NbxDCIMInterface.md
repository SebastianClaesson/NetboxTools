...
```
Set-NbxDCIMInterface [-Id] <ulong[]> [[-Device] <ulong>] [[-Name] <string>] [[-Enabled] <bool>]
 [[-Form_Factor] <Object>] [[-Type] <string>] [[-MTU] <ushort>] [[-MAC_Address] <string>]
 [[-MGMT_Only] <bool>] [[-LAG] <ulong>] [[-Description] <string>] [[-Mode] <string>]
 [[-Untagged_VLAN] <ushort>] [[-Tagged_VLANs] <ushort[]>] [-Force] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
