...
title: Set-NbxDCIMInterfaceConnection
---
...
```
Set-NbxDCIMInterfaceConnection [-Id] <ulong[]> [[-Connection_Status] <Object>]
 [[-Interface_A] <ulong>] [[-Interface_B] <ulong>] [-Force] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
