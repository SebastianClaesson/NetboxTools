...
```
Set-NbxDCIMRearPort [-Id] <ulong[]> [[-Device] <ulong>] [[-Module] <ulong>] [[-Name] <string>]
 [[-Label] <string>] [[-Type] <string>] [[-Color] <string>] [[-Positions] <ushort>]
 [[-Description] <string>] [[-Mark_Connected] <bool>] [[-Tags] <ushort[]>] [-Force] [-WhatIf]
