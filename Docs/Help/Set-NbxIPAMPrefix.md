...
```
Set-NbxIPAMPrefix [-Id] <ulong[]> [[-Prefix] <string>] [[-Status] <string>] [[-Tenant] <ulong>]
 [[-Site] <ulong>] [[-VRF] <ulong>] [[-VLAN] <ulong>] [[-Role] <Object>]
 [[-Custom_Fields] <hashtable>] [[-Description] <string>] [-Is_Pool] [-Force] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
