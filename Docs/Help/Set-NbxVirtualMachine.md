...
```
Set-NbxVirtualMachine [-Id] <ulong> [[-Name] <string>] [[-Role] <ulong>] [[-Cluster] <ulong>]
 [[-Status] <Object>] [[-Platform] <ulong>] [[-Primary_IP4] <ulong>] [[-Primary_IP6] <ulong>]
 [[-VCPUs] <byte>] [[-Memory] <ulong>] [[-Disk] <ulong>] [[-Tenant] <ulong>] [[-Comments] <string>]
