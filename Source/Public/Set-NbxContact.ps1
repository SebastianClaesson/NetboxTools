...
<#
    ...
    .EXAMPLE
        PS C:\> Set-NbxContact -Id 10 -Name 'Leroy Jenkins' -Email 'leroy.jenkins@example.com'
...
#>
    ...
    process {
        foreach ($ContactId in $Id) {
            ...
            $CurrentContact = Get-NbxContact -Id $ContactId -ErrorAction Stop
