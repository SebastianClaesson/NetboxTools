function Set-NbxContactAssignment {
...
<#
    ...
    .EXAMPLE
        PS C:\> Set-NbxContactAssignment -Id 11 -Content_Type 'dcim.location' -Object_id 10 -Contact 15 -Role 10 -Priority 'Primary'
...
#>
    ...
    process {
        foreach ($ContactAssignmentId in $Id) {
            ...
            $CurrentContactAssignment = Get-NbxContactAssignment -Id $ContactAssignmentId -ErrorAction Stop
